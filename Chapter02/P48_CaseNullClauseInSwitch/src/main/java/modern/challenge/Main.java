...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        createPlayerNullAndNonDefaultCase(PlayerTypes.TENNIS);
        createPlayerNullAndNonDefaultCase(null);
        createPlayerNullAndNonDefaultCase(PlayerTypes.UNKNOWN);
    }
    ...
    private static Player createPlayerNullAndNonDefaultCase(PlayerTypes playerType) {
    ...
    private static Player createPlayerNullAndNonDefaultCaseYield(PlayerTypes playerType) {
